...
ingredients:
  - id: tortillas
    ...
    unit: unit
    item:
      en: "whole wheat flour tortillas"
  ...
  - id: egg_water
    ...
    item:
      ...
      es: "agua"
    note:
      en: "a splash; it helps them be softer"
      ca: "una mica; ajuda que quedin més tous"
      es: "un poco; ayuda a que queden más suaves"
    onlyForVariation: [egg]
  - id: chicken_breast
    emoji: "🍗"
    amount: 150
  ...
  - id: cheese
    ...
    item:
      ...
      es: "queso"
    note:
      en: "optional: mozzarella or parmesan, ideally Honduran cheese"
      ca: "opcional: mozzarella o parmesà, idealment formatge hondureny"
      es: "opcional: mozzarella o parmesano, idealmente queso hondureño"
  - id: avocado
    amount: 0
    unit: as_needed
    item:
      ...
      es: "aguacate"
    note:
      en: "optional, in pieces"
      ca: "opcional, a trossos"
      es: "opcional, en trozos"
  - id: hot_sauce
    emoji: "🌶️"
    amount: 0
    unit: to_taste
    item:
      ...
      es: "salsa picante"
    note:
      en: "ideally Don Julio from Honduras; Valentina or any other works too"
      ca: "idealment Don Julio d'Hondures; la Valentina o qualsevol altra també funciona"
      es: "idealmente Don Julio de Honduras; la Valentina o cualquier otra también funciona"
  - id: salt
    amount: 0
    unit: to_taste
    item:
...
1. In a [small bowl](tool:bowl), beat the [eggs](i:eggs) with a splash of [water](i:egg_water), [salt](i:salt) and [black pepper](i:black_pepper), then cook them in a [frying pan](tool:frying_pan) over low heat, stirring often. {variant: egg}
