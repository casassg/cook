...
tools:
  ...
  - id: microwave
    icon: "🔥"
    name: { en: "microwave", ca: "microones", es: "microondas" }
    note:
      en: "or a small saucepan over low heat"
      ca: "o una cassola petita a foc baix"
      es: "o un cazo pequeño a fuego lento"
ingredients:
  - id: potato
    amount: 1300
    unit: g
...
8. Taste and season with extra [salt](i:salt) if needed. Serve warm, finished with freshly cracked [black pepper](i:black_pepper).